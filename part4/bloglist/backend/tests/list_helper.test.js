...
describe('total likes', () => {
  ...
  test('when list has multiple blogs, equals the likes of all blogs combined', () => {
...
describe('favorite blog', () => {
  ...
  test('when list has only one blog, that blog is returned', () => {
    ...
    expect(result).toEqual({ _id: '5a422a851b54a676234d17f7', title: 'React patterns', author: 'Michael Chan', url: 'https://reactpatterns.com/', likes: 7, __v: 0 })
  })

  test('when list has multiple blogs, the blog with the most likes is returned', () => {
